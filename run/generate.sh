...
exp_dir="../output/DiffuScene_pretrained"
...
threed_future='../output/pickled_datasets/threed_future_model_bedroom.pkl'
...
weight_file="$exp_dir/$exp_name/$exp_name.pt"
threed_future='../output/pickled_datasets/threed_future_model_diningroom.pkl'
...
weight_file="$exp_dir/$exp_name/$exp_name.pt"
threed_future='../output/pickled_datasets/threed_future_model_livingroom.pkl'
